...
1. The complete transcript of a call (see an example [here](data/test_txt.txt)) in `.txt` format.
2. The complete recording of a call (see an example [here](data/test_wav.wav)) in `.wav` format.
